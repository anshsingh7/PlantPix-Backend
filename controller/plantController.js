...
const plantFilterController = async (req, res) => {
  try {
...
//Product per page
const plantListController = async (req, res) => {
  try {
    const perPage = 8;
...
export {
  ...
  getPlantController,
  getSinglePlantController,
  plantPhotoController,
  deletePlantController,
  updatePlantController,
  plantFilterController,
  plantCountController,
  plantListController,
  searchPlantController,
  realtedPlantController,
